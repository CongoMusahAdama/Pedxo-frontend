    ...
    const sendFinalForm = () => {
        ...
        const mutationPromise = finalize(formData, {
            onSuccess: (data) => {
                ...
                // Clear contract session ID so next submission creates a new contract
                sessionStorage.removeItem('contractSessionId');
                console.log('[CONTRACT_SESSION] Cleared contractSessionId');
